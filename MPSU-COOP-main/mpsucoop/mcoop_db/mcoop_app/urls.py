...
UpdateMemberViews,
    ...
    payment_schedules_by_loan, AccountDetailView, get_payments,get_members, MemberPaymentsView,PaymentListByScheduleView, PaymentsByAccountView, ArchiveViewSet,loan_summary, LogActionAPIView, GetAuditLogsAPIView,process_payment_view
)
...
urlpatterns = [
    ...
    path('api/members/get-members/', views.get_members, name='get-members'),
