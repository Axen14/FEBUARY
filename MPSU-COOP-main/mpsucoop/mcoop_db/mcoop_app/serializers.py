...
class MemberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Member
        fields = [
            'memId', 'first_name', 'middle_name', 'last_name', 'accountN','user','share_capital', 
            'email', 'phone_number', 'gender', 'religion', 'pstatus', 'address',
            'birth_date', 'birth_place', 'age', 'zip_code', 'height', 'weight',
            'ann_com', 'co_maker', 'mem_co', 'relationship', 'tin', 'in_dep',
            'valid_id', 'id_no'
        ]
